...
public class Profil extends JPanel {
	...
	public int getSpielzeit(int spielzeit) throws DB_FehlerException {
		dao.selectSpielzeit(spielzeit);
		return spielzeit;
		String spielzeitgesamt = Integer.toString(spielzeit);
		textFieldSpielzeitgesamt.setText(spielzeitgesamt);''
	}
